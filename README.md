...
## Current status
The current rebuild is a staging release candidate. Local source, accessibility, browser, and output gates are recorded in the course audit folder. Public deployment follows independent review of the exact staging commit.
