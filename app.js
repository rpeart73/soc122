...
(function () {
  ...
  function sidebar() {
    var s = state;
    var navDefs = [['journey', 'Home', 'gauge'], ['site', 'How This Site Works', 'file'], ['pathways', 'Course Pathways', 'map'], ['readings', 'Readings and Media', 'gallery'], ['compare', 'Compare Sources', 'columns'], ['reading', 'Source Practice', 'book'], ['videos', 'Videos and Podcasts', 'play'], ['glossary', 'Glossary', 'book'], ['cards', 'Concept Flashcards', 'clipboard'], ['assignments', 'Starting Your Assignment', 'clipboard'], ['career', 'Career Choices', 'globe']];
  ...
  function weekPage(w, d) {
    ...
    var media = weekMedia.length ? '<section id="wk-media" class="node"><h2 class="wk-sec">Watch and question</h2><p class="wk-hint">' + mediaHint + '</p><div class="vid-grid">' + weekMedia.map(videoCard).join('') + '</div></section>' : '';
