...
(function () {
  ...
  window.SOC122_CASES = {
    1: {
      ...
      title: 'Marie Battiste asks us to rethink where learning lives',
      image: 'images/people/w01_marie_battiste_usask.png', imageKind: 'real', ready: true,
      alt: 'Marie Battiste smiles in a head-and-shoulders portrait against a white background.',
      credit: 'University of Saskatchewan; photographer not stated on source page',
      source: 'https://education.usask.ca/people/profiles/battiste.php',
      why: 'The week opens with a broad public scene because social science studies patterned collective life. Here the focus narrows to Marie Battiste, a Mi\'kmaw scholar whose account of the learning spirit expands where learning happens and who carries knowledge.',
      notice: 'Battiste is named and her teaching stays attributed. She is not asked to stand in for all Indigenous knowledge.',
      question: 'What changes when learning is understood as a lifelong relationship with family, community, land, and purpose rather than only as schooling?',
      sourceIds: ['battiste', 'ermine', 'soc-intro']
    },
    2: {
      eyebrow: 'KNOWLEDGE HOLDER',
    ...
    3: {
      eyebrow: 'SCHOLAR IN CONTEXT',
      title: 'Debbie Martin centres community-led research',
      image: 'images/people/w03_debbie_martin_dalhousie.jpg', imageKind: 'real', ready: true,
      alt: 'Debbie Martin stands for a portrait in a light indoor setting.',
      credit: 'Dalhousie University; photographer not stated on source page',
      source: 'https://www.dal.ca/faculty/health/health-humanperformance/faculty-staff/our-faculty/health-promotion/debbie-martin.html',
      why: 'The week-opening collage refuses to make one person represent Indigenous Canada. This chapter then introduces Debbie Martin as one named scholar whose work in Indigenous health and community-led research offers a specific place from which to learn.',
      notice: 'Keep the scale honest: one scholar, one body of work, and one context within many distinct Nations, communities, and knowledge traditions.',
      question: 'How does a research question change when a community helps set the priorities, methods, interpretation, and use of the findings?',
      sourceIds: ['martin2012', 'brunette2022']
    },
    4: {
      eyebrow: 'SURVIVOR STORY IN CONTEXT',
      title: 'Orange Shirt Day begins with Phyllis Webstad\'s story',
      image: 'images/people/w04_phyllis_webstad_jibc.jpg', imageKind: 'real', ready: true,
      alt: 'Phyllis Webstad stands outdoors wearing an orange shirt and smiling toward the camera.',
      credit: 'Justice Institute of British Columbia; photographer not stated on source page',
      source: 'https://www.jibc.ca/news/article/jibc-recognize-orange-shirt-day-founder-vancouvers-first-female-fire-chief',
      why: 'The week opens with the residential-school institution in view. This chapter then names Phyllis Webstad, a Stswecem\'c Xgat\'tem First Nation member and residential school Survivor whose account of having her orange shirt taken away began Orange Shirt Day.',
      notice: 'Her story is specific and attributed. It does not stand in for every Survivor or every residential-school experience.',
      question: 'What responsibility follows when a public symbol is reconnected to the named Survivor, institutional system, and ongoing work that gave it meaning?',
      sourceIds: ['smylie']
    },
    5: {
      eyebrow: 'RELATIONSHIP IN VIEW',
      title: 'Andrea Reid and Two-Eyed Seeing in fisheries research',
      image: 'images/people/w05_andrea_reid_cif.jpg', imageKind: 'real', ready: true,
      alt: "Portrait of Dr. Andrea Reid, a Nisga'a scholar of Indigenous fisheries, in front of a colourful floral Indigenous artwork.",
      credit: 'Centre for Indigenous Fisheries, University of British Columbia; photographer not stated',
      source: 'https://www.cif.fish/andrea-reid',
      why: "Andrea Reid, a Nisga'a fisheries scientist at UBC, argues that Two-Eyed Seeing is an action imperative: Indigenous and Western knowledge sit as equal, coexisting authorities, not one folded into the other. Her fisheries research keeps the accountable questions in view, who sets the question, who interprets the findings, who governs the data, and who benefits, alongside sampling and measurement.",
      notice: 'Ask about the relationship around the evidence: who set the question, who interpreted the findings, who benefits, and who can refuse.',
      question: 'What would you need to know about the relationships in a study before deciding that its methods are not only valid, but accountable?',
      sourceIds: ['reid2021', 'soc-research']
    },
    6: {
      eyebrow: 'ANTHROPOLOGIST IN CONTEXT',
      title: 'Zoe Todd asks who anthropology recognizes as a theorist',
      image: 'images/people/w06_zoe_todd_carleton.png', imageKind: 'real', ready: true,
      alt: 'Zoe Todd looks toward the camera in an outdoor winter portrait beside a wide body of water.',
      credit: 'Carleton University; photographer not stated on source page',
      source: 'https://carleton.ca/gwi/people/zoe-todd/',
      why: 'The week-opening scene treats culture as relationship among people, objects, work, memory, and place. Zoe Todd, a Métis anthropologist, then makes the discipline itself part of the analysis by asking whose knowledge is cited, translated, or excluded as theory.',
      notice: 'Do not turn Todd into an Indigenous addition to an otherwise unchanged discipline. Her critique asks anthropology to examine its own authority and citation practices.',
      question: 'Who becomes a theorist, who becomes data, and what changes when the people interpreted by a discipline can challenge its categories?',
      sourceIds: ['anth-culture', 'todd2016']
    },
    8: {
      eyebrow: 'SCHOLAR IN CONTEXT',
      title: 'Bonita Lawrence makes the state\'s power to define identity visible',
      image: 'images/people/w08_bonita_lawrence_kings.png', imageKind: 'real', ready: true,
      alt: 'Bonita Lawrence smiles in a close portrait wearing glasses and a blue shawl.',
      credit: 'University of King\'s College; photographer not stated on source page',
      source: 'https://ukings.ca/news/dr-bonita-lawrence-guest-lectures-on-indigenous-black-relations/',
      why: 'The opening scene shows the social changes that helped produce Western sociology. Bonita Lawrence, a Mi\'kmaw scholar, then makes a Canadian structure visible: settler law did not merely describe Indigenous identity; it regulated belonging through state categories.',
      notice: 'Keep Lawrence\'s account specific. It is not a general example of socialization, but an analysis of colonial law, identity regulation, and nationhood.',
      question: 'What becomes visible when identity is studied not only as something people learn, but as something a state can classify and regulate?',
      sourceIds: ['soc-history', 'soc-socialization', 'lawrence2003']
    },
    9: {
      eyebrow: 'STRUCTURAL ACCOUNT IN CONTEXT',
      title: 'Pamela Palmater locates inequality in law and policy',
      image: 'images/people/w09_pamela_palmater_tmu.jpg', imageKind: 'real', ready: true,
      alt: 'Pamela Palmater speaks at a podium during Indigenous Education and Treaties Week.',
      credit: 'Photo by Nadya Kwandibens, Toronto Metropolitan University',
      source: 'https://www.torontomu.ca/news-events/news/2025/01/why-we-need-substantive-action-reconciliation/',
      why: 'The opening image makes normalization, ranking, and institutional power visible. Pamela Palmater, a Mi\'kmaw lawyer and member of Eel River Bar First Nation, provides a distinct Canadian account of how colonial laws and policies produce material inequality.',
      notice: 'Palmater\'s analysis is not evidence that merely confirms a general Western theory. Read its legal, political, and First Nations context on its own terms.',
      question: 'How does an explanation change when inequality is traced to the rules that produced it rather than blamed on the people living with the outcome?',
      sourceIds: ['tz-number12', 'blackmirror-nosedive', 'althusser1970', 'soc-stratification', 'palmater']
    },
    10: {
      eyebrow: 'PSYCHOLOGIST IN CONTEXT',
      title: 'Joseph Gone asks whether psychology serves Indigenous communities on their terms',
      image: 'images/people/w10_joseph_gone_ict.jpg', imageKind: 'real', ready: true,
      alt: 'Joseph P. Gone stands outdoors on a university campus and looks toward the camera.',
      credit: 'Photo by Stephanie Mitchell, Harvard University',
      source: 'https://ictnews.org/news/professor-honored-for-research-on-indigenous-psychology/',
      why: 'The week-opening scene keeps psychology\'s methods, institutions, labels, and histories visible. Joseph P. Gone, a citizen of the Aaniiih-Gros Ventre Nation, then questions whether mainstream mental-health frameworks fit Indigenous experience and community priorities.',
      notice: 'This comparison is not a diagnosis and does not ask for personal disclosure. Gone\'s work is read as scholarship about history, culture, community, and alternatives.',
      question: 'What would responsible care need to change if the community, not only the discipline, helped define the problem and the response?',
      sourceIds: ['psych-history', 'tz-nightmare20000', 'camh-queen-history', 'phac-mental-health-inequalities', 'gone2023']
    },
    11: {
      eyebrow: 'SCHOLARSHIP IN ITS OWN CONTEXT',
      title: 'Amy Bombay studies intergenerational effects with community context intact',
      image: 'images/people/w11_amy_bombay_dalhousie.jpg', imageKind: 'real', ready: true,
      alt: 'Amy Bombay stands in a bright university corridor and looks toward the camera.',
      credit: 'Photo by Danny Abriel, Dalhousie University',
      source: 'https://www.dal.ca/news/2019/06/21/building-capacity-in-indigenous-health-research-and-beyond.html',
      why: 'The opening image asks students to audit the Stanford Prison Experiment as an institution and public story. Amy Bombay, an Anishinaabe scholar and member of Rainy River First Nations, appears here for a different question about residential-school history, intergenerational effects, resilience, and community context.',
      notice: 'Do not collapse the sources. Bombay does not validate the prison-study account, and the prison study does not explain Indigenous communities.',
      question: 'How do history, community context, and the purpose of a study change what its evidence can responsibly be used to claim?',
      sourceIds: ['stanford-prison-archive', 'letexier2019', 'psy-social', 'bombay2014']
    },
    12: {
      eyebrow: 'SCHOLAR IN CONTEXT',
      title: 'Kim Anderson centres kinship, story, care, and relational futures',
      image: 'images/people/w12_kim_anderson_guelph.png', imageKind: 'real', ready: true,
      alt: 'Kim Anderson smiles in an outdoor seated portrait.',
      credit: 'University of Guelph; photographer not stated on source page',
      source: 'https://www.uoguelph.ca/profile/kim-anderson',
      why: 'The week opens with a collective design workshop for Nokom\'s House, where space and responsibility are planned together. Kim Anderson, a Métis scholar, then provides a named body of work on kinship, story, care, and Indigenous relational futures.',
      notice: 'Do not reduce kinship to household structure or treat one scholar as speaking for every Indigenous family. Keep Anderson\'s relational framing attributed and specific.',
      question: 'What becomes visible when family is understood through ongoing care, memory, story, land, and responsibility rather than only through household categories?',
