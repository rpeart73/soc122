/* Optional weekly journal planning prompts. Only Assessment 2 is a graded private journal: two dated entries, 10%. Assessment 4 is a separate graded discussion. These prompts create no additional submissions. */
window.SOC122_JOURNAL = {
  byWeek: {
    ...
    "2": {
      bridge: "Optional planning prompt: Use Marshall and Little Bear to explore one specific observation and what your starting social science approach does or does not explain. Assessment 2 is the graded private journal: submit two dated entries by October 14, 2026 at 11:59 p.m. Eastern. Its 48-hour no-penalty window ends October 16, 2026 at 11:59 p.m. Eastern. You do not need an entry every week or a separate flagged-entry submission. Read the current guide for the complete task and grading criteria.",
      moves: [
    ...
    "3": {
      bridge: "Optional planning prompt: Use Martin or Brunette-Debassige and colleagues to examine who decides which knowledge counts in one setting. Assessment 2 is the graded private journal: submit two dated entries by October 14, 2026 at 11:59 p.m. Eastern. Its 48-hour no-penalty window ends October 16, 2026 at 11:59 p.m. Eastern. You do not need an entry every week or a separate flagged-entry submission. Read the current guide for the complete task and grading criteria.",
      moves: [
    ...
    "4": {
      bridge: "Optional planning prompt: Use a named course source to examine an institutional responsibility without speaking for a community. Assessment 2 is the graded private journal: submit two dated entries by October 14, 2026 at 11:59 p.m. Eastern. Its 48-hour no-penalty window ends October 16, 2026 at 11:59 p.m. Eastern. You do not need an entry every week or a separate flagged-entry submission. Read the current guide for the complete task and grading criteria.",
      moves: [
    ...
    "5": {
      bridge: "Optional planning prompt: Use the Marketplace investigation to practise distinguishing an observation from a causal claim, then consider a named Indigenous or Two-Eyed Seeing course source. Assessment 2 is the graded private journal: submit two dated entries by October 14, 2026 at 11:59 p.m. Eastern. Its 48-hour no-penalty window ends October 16, 2026 at 11:59 p.m. Eastern. You do not need an entry every week or a separate flagged-entry submission. Read the current guide for the complete task and grading criteria.",
      moves: [
    ...
    "6": {
      bridge: "Optional planning prompt: Use OpenStax and Todd to examine one low-risk observation about culture, credit, and responsibility. Assessment 2 is the graded private journal: submit two dated entries by October 14, 2026 at 11:59 p.m. Eastern. Its 48-hour no-penalty window ends October 16, 2026 at 11:59 p.m. Eastern. You do not need an entry every week or a separate flagged-entry submission. Read the current guide for the complete task and grading criteria.",
      moves: [
    ...
    "7": {
      bridge: "Optional planning prompt: Revisit two sources already studied; there is no new reading. Identify what each helps you see and one unresolved question. Assessment 2 is the graded private journal: submit two dated entries by October 14, 2026 at 11:59 p.m. Eastern. Its 48-hour no-penalty window ends October 16, 2026 at 11:59 p.m. Eastern. You do not need an entry every week or a separate flagged-entry submission. Read the current guide for the complete task and grading criteria.",
      moves: [
    ...
    "8": {
      bridge: "Optional planning prompt: Consider how OpenStax and Lawrence explain an observed identity category from different starting points. This is optional thinking space, not a second graded journal. For Assessment 4, One Issue, Different Perspectives (10%), follow the separate discussion instructions in Blackboard. You do not need an entry every week or a separate flagged-entry submission. Read the current guide for the complete task and grading criteria.",
      moves: [
    ...
    "9": {
      bridge: "Optional planning prompt: Use OpenStax and Palmater to examine one specific pattern of inequality without treating their accounts as interchangeable. This is optional thinking space, not a second graded journal. For Assessment 4, One Issue, Different Perspectives (10%), follow the separate discussion instructions in Blackboard. You do not need an entry every week or a separate flagged-entry submission. Read the current guide for the complete task and grading criteria.",
      moves: [
    ...
    "10": {
      bridge: "Optional planning prompt: Keep your account focused on ideas and evidence when comparing OpenStax and Gone; no personal health disclosure is required. This is optional thinking space, not a second graded journal. For Assessment 4, One Issue, Different Perspectives (10%), follow the separate discussion instructions in Blackboard. You do not need an entry every week or a separate flagged-entry submission. Read the current guide for the complete task and grading criteria.",
      moves: [
    ...
    "11": {
      bridge: "Optional planning prompt: Use the assigned social psychology and Bombay readings to explore an attributed structural or historical explanation. This is optional thinking space, not a second graded journal. For Assessment 4, One Issue, Different Perspectives (10%), follow the separate discussion instructions in Blackboard. You do not need an entry every week or a separate flagged-entry submission. Read the current guide for the complete task and grading criteria.",
      moves: [
    ...
    "12": {
      bridge: "Optional planning prompt: Use OpenStax and Anderson to examine one household or family example through both structure and daily responsibility. This is optional thinking space, not a second graded journal. For Assessment 4, One Issue, Different Perspectives (10%), follow the separate discussion instructions in Blackboard. You do not need an entry every week or a separate flagged-entry submission. Read the current guide for the complete task and grading criteria.",
      moves: [
        ...
        "If useful, revisit an earlier note and identify one way your interpretation has changed. This planning prompt has no required submission, deadline or grade."
      ]
    }
  },
  compiler: {
    /* Optional practice record; browser notes do not submit to Blackboard. */
    intro: "This page gathers your saved weekly reflections in one place so you can see your Two-Eyed Seeing practice as a running record. Only Assessment 2 is a graded private journal. It requires two dated entries by October 14, 2026 at 11:59 p.m. Eastern; its no-penalty window ends October 16, 2026 at 11:59 p.m. Eastern. Assessment 4 is the separate One Issue, Different Perspectives discussion, not a second journal. Each entry begins with a specific class item, public issue, or low-risk observation, then holds one social science lens beside a named Indigenous or Two-Eyed Seeing course source. Notes saved here live only in this browser on this device, so treat this page as working space and submit the required entries in Blackboard."
  }
};
